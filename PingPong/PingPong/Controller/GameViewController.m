...
- (void)configurePaddles {
    self.paddleTop = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - PADDLE_X_SHIFT - PADDLE_WIDTH,
                                                                   PADDLE_Y_SHIFT,
                                                                   PADDLE_WIDTH,
                                                                   PADDLE_HEIGHT)];
    ...
    self.paddleBottom = [[UIImageView alloc] initWithFrame:CGRectMake(PADDLE_X_SHIFT,
                                                                      SCREEN_HEIGHT - PADDLE_HEIGHT - PADDLE_Y_SHIFT,
                                                                      PADDLE_WIDTH,
                                                                      PADDLE_HEIGHT)];
...
- (void)configureBall {
    self.ball = [[UIView alloc] initWithFrame:CGRectMake(self.view.center.x - BALL_SIZE / 2,
...
- (void)configureScores {
    self.scoreTop = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - SCORE_POSITION_SHIFT,
                                                              HALF_SCREEN_HEIGHT - SCORE_POSITION_SHIFT,
                                                              SCORE_SIZE,
                                                              SCORE_SIZE)];
    ...
    self.scoreBottom = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - SCORE_POSITION_SHIFT,
                                                                 HALF_SCREEN_HEIGHT + SCORE_POSITION_SHIFT - self.scoreTop.font.pointSize,
                                                                 SCORE_SIZE,
                                                                 SCORE_SIZE)];
